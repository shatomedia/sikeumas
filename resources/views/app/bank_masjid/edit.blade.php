...
@section('content-tenant')
    ...
    <section class="section">
        <div class="card">
            ...
            @endif
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('masjid-bank.update', $data->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                <input type="text" id="nama_rekening" class="form-control mb-3" name="nama_rekening"
                                    placeholder="Atas Nama" value="{{ $data->nama_rekening }}">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-12 form-group">
                                <input type="text" id="nomor_rekening" class="form-control mb-3" name="nomor_rekening"
                                    placeholder="Nomor Rekening" value="{{ $data->nomor_rekening }}">
                            </div>
