...
@section('content-tenant')
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('informasi.update', $data['profile']->id) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                <select class="form-select" id="kategori_id" name="kategori_id">
                                    @foreach ($data['listKategori'] as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ $key == $data['profile']->kategori_id ? 'selected' : '' }}>
                                            {{ ucwords($value) }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-12 form-group">
                                <input type="date" id="tanggal" class="form-control mb-3" name="tanggal"
                                    placeholder="Pilih Tanggal" value="{{ old('tanggal', $data['profile']->tanggal) }}">
                            </div>
                            <div class="col-md-12">
