...
@section('content-tenant')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Tambah Informasi Kurban</h3>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Informasi Kurban</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="section">
        <div class="card">
            ...
            @endif
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('kurban.store') }}" method="POST">
                    @csrf
                    <div class="form-body">
                        <div class="row">
