    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('profile-masjid.create') }}" class="btn btn-primary float-end">Tambah Profil Masjid</a>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($profile as $item)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center">
                                        <a href="{{ route('profile-masjid.edit', $item->id) }}"
                                        ...
                                        <form action="{{ route('profile-masjid.destroy', $item->id) }}" method="POST">
                                            @method('DELETE')
                                            @csrf
